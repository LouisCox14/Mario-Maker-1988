...
void GameScreenLevel1::Update(float deltaTime, SDL_Event e)
{
	...
	float cameraX = (mario->GetPosition().x + luigi->GetPosition().x + mario->GetSize().x) / 2 - SCREEN_WIDTH / 2;
...
bool GameScreenLevel1::SetUpLevel(float levelScale)
{
	...
	mario = (Character*)new SmallMario(m_renderer, "Sprites/Small Mario/Idle.png", Vector2D(64, 64), levelScale, cameraPosition);
	luigi = (Character*)new SmallLuigi(m_renderer, "Sprites/Small Luigi/Idle.png", Vector2D(64, 64), levelScale, cameraPosition);
